...
<section class="sec">
  ...
  <div class="wrap stats" data-stats>
    <div class="stat">
      <svg class="stat__ic" viewBox="0 0 64 64" aria-hidden="true"><path pathLength="1" d="M8 44h48M14 44a18 18 0 0 1 36 0M32 14v-6M14.4 21.4l-4.2-4.2M49.6 21.4l4.2-4.2M6 32H2m60 0h-4M18 52h28M24 58h16"/></svg>
      <b class="stat__n"><span data-count="23">23</span></b>
      <span class="stat__t">Jaar ervaring in Spanje</span>
    </div>
    <div class="stat">
      <svg class="stat__ic" viewBox="0 0 64 64" aria-hidden="true"><path pathLength="1" d="M32 30a9 9 0 1 0 0-18 9 9 0 0 0 0 18ZM16 54c0-9 7-16 16-16s16 7 16 16M12 30a6 6 0 1 0 0-12 6 6 0 0 0 0 12ZM52 30a6 6 0 1 0 0-12 6 6 0 0 0 0 12ZM2 50c0-6 4-11 10-11M62 50c0-6-4-11-10-11"/></svg>
      <b class="stat__n"><span data-count="16">16</span></b>
      <span class="stat__t">Experts</span>
    </div>
    <div class="stat">
      <svg class="stat__ic" viewBox="0 0 64 64" aria-hidden="true"><path pathLength="1" d="M8 30 32 10l24 20M14 25v29h36V25M26 54V40h12v14M24 32l6 6 11-12"/></svg>
      <b class="stat__n"><span data-count="120">120</span><i>+</i></b>
      <span class="stat__t">Tevreden klanten</span>
    </div>
  </div>
</section>

<section class="rail-sec rail-sec--car bg-white">
  <div class="rail__pin">
    ...
    <div class="rail">
      ...
      <div class="rail__track" data-carousel>{rail}</div>
    </div>
  </div>
</section>
